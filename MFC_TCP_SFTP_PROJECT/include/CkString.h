...
class CK_VISIBLE_PUBLIC CkString : public CkObject
{
	...
	// such as "iso-8859-1", "windows-1253", "Shift_JIS", etc.
        bool loadFile(const char *chipPath, const char *charset);
	bool loadFileW(const wchar_t *chipPath, const wchar_t *charset);
	...
	bool saveToFile(const char *chipPath, const char *charset);
	bool saveToFileW(const wchar_t *chipPath, const wchar_t *charset);
